...
// Formato correto: v1beta + gemini-1.0-pro-latest (modelo gratuito estável)
const GEMINI_API_URL = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.0-pro-latest:generateContent';
