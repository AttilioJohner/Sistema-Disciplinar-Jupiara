...
class SupabaseConfig {
  constructor() {
    // URLs de configuração (usar variáveis de ambiente do Netlify ou definir direto)
    this.supabaseUrl = window.NETLIFY_ENV?.SUPABASE_URL || window.SUPABASE_URL || 'https://rvppxdhrahcwiwrrwwaz.supabase.co';
    this.supabaseKey = window.NETLIFY_ENV?.SUPABASE_ANON_KEY || window.SUPABASE_ANON_KEY || '';
